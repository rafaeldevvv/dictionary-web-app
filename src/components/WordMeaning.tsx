...
export default function WordMeaning({ meaning }: { meaning: Meaning }) {
   ...
   const areSynonymsAvailable =
      ...
      areAntonymsAvailable = meaning.antonyms && meaning.antonyms.length !== 0;
   return (
      <section aria-labelledby={id}>
         ...
         {areSynonymsAvailable && (
            <div className="mt-8">
               <HomonymsList areSynonyms={true} words={meaning.synonyms!} />
            </div>
         )}
         {areAntonymsAvailable && (
            <div className="mt-4">
               <HomonymsList areSynonyms={false} words={meaning.antonyms!} />
            </div>
         )}
      </section>
   );
